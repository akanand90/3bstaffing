...
const HealthcareTalent = () => {
        ...
        <div className='container'>
          <div className='heading-title'>
            ...
            <Title title='Healthcare Talent Solutions'  className='title-bg' />
             <br />
            <br />
            <TitleSm title=' For decades, the greatest brands have relied on eTeam for
            Nursing and Allied Health Staffing Solutions'/>
 ...
 <div class="d-flex justify-content-between">
  <div class="p-2" style={{"width":400}}>
    ...
    <p>In more than 50 countries, eTeam provides quality talent for all industries that rely on healthcare professionals.</p><br/>
    <br/>
    <p>From healthcare and pharmaceutical, to clinical, you can come to eTeam for top talent in any healthcare role</p>

    <Accordion title="Travel Nurse" content="With a robust network of fully-vetted, highly-qualified and flexible travel nurses, eTeam is ready to fill gaps and meet your organization's nurse staffing needs." />
...
<img src="../images/healthimg1.jpg" width='100%'/>
  ...
  <div class="p-2" style={{"width":400}}>
    ...
    <br/>
    <p>Our award-winning service attracts and retains a vibrant network of top talent throughout EMEA, Americas and APAC. So, you can efficiently secure allied health clinicians from any disciplines and setting: .</p>
    ...
    <Accordion title="Respiratory " content="Healthcare facilities across the globe depend on eTeam for qualified candidates to fill laboratory positions. Our talent pool is pre-vetted, ready-to-work and spans a variety of disciplines and settings – from local contractors and travel clinicians, to seasonal staffing or per diem workers." />
    <Accordion title="Therapy" content="Our robust network of qualified and trusted therapy professionals will relieve your allied therapy staffing needs. Our outstanding customer service and expert team of therapy professionals will take your therapy staffing to the next level." />
    <Accordion title="Local and Per-diem" content="We specialize in recruiting for per-diem allied healthcare professionals. As your trusted partner, our allied per-diem staffing solutions will meet your current and future needs." />
